...
export function ProfileView() {
    ...
    return (
      <div className="flex min-h-96 flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-body-md text-muted-foreground mb-6 max-w-xl">
          Crie seu perfil para começar no MatchFight. Adicione seu apelido,
          bio, função, categoria de peso e mais para se conectar com outros
          lutadores e juízes.
        </p>
  ...
  if (diffDays === 0) joinedDate = "Hoje";
    ...
    joinedDate = `Há ${Math.ceil(diffDays / 7)} semanas`;
  else if (diffDays < 365)
    joinedDate = `Há ${Math.ceil(diffDays / 30)} meses`;
