...
describe('Fight Router', () => {
  ...
  describe('byId', () => {
    it('happy path: returns the fight with fighter1/fighter2 objects including nickname', async () => {
      ...
      expect([fight.fighter1Id, fight.fighter2Id]).toEqual(expect.arrayContaining([userIdA, userIdB]));
