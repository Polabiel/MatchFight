...
export function Sidebar({
  ...
  return (
    <aside
      data-slot="sidebar"
      className={cn(
        "bg-sidebar text-sidebar-foreground border-sidebar-border flex h-svh w-72 shrink-0 flex-col overflow-y-auto border-r-2",
        className,
      )}
      {...props}
    />
...
export function SidebarFooter({
  ...
  return (
    <footer
      ...
      className={cn(
        "border-sidebar-border shrink-0 border-t-2 px-4 py-6",
        className,
      )}
      {...props}
    />
